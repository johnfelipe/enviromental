A stripped down version of the toolbox theme, with no css and stripped down PHP, because though i love this theme, I always end up removing the css before i start anything.
-------previous toolbox info -----
== Changelog ==
